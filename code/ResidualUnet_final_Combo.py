...
ckpt_dir = './ResidualUnet_seg_final_Combo/checkpoint'
log_dir = './ResidualUnet_seg_final_Combo/log'
result_dir = './ResidualUnet_seg_final_Combo/result'
mode = 'train'
train_continue = 'off'
kf_type = True
